...
void BM_HomGate(benchmark::State& state){
    ...
    TFHEpp::TLWE<TFHEpp::lvl0param> ca = TFHEpp::tlweSymEncrypt<TFHEpp::lvl0param>(binary(engine),TFHEpp::lvl0param::alpha,sk->key.lvl0);
    TFHEpp::TLWE<TFHEpp::lvl0param> cb = TFHEpp::tlweSymEncrypt<TFHEpp::lvl0param>(binary(engine),TFHEpp::lvl0param::alpha,sk->key.lvl0);
...
void BM_HomMUX(benchmark::State& state){
    ...
    TFHEpp::TLWE<TFHEpp::lvl0param> ca = TFHEpp::tlweSymEncrypt<TFHEpp::lvl0param>(binary(engine),TFHEpp::lvl0param::alpha,sk->key.lvl0);
    TFHEpp::TLWE<TFHEpp::lvl0param> cb = TFHEpp::tlweSymEncrypt<TFHEpp::lvl0param>(binary(engine),TFHEpp::lvl0param::alpha,sk->key.lvl0);
    TFHEpp::TLWE<TFHEpp::lvl0param> cs = TFHEpp::tlweSymEncrypt<TFHEpp::lvl0param>(binary(engine),TFHEpp::lvl0param::alpha,sk->key.lvl0);
    TFHEpp::TLWE<TFHEpp::lvl0param> res;
...
void BM_IKS(benchmark::State& state){
    ...
    const std::unique_ptr<TFHEpp::SecretKey> sk(new TFHEpp::SecretKey());
    const std::unique_ptr<TFHEpp::GateKey> gk(new TFHEpp::GateKey(*sk));
    TFHEpp::TLWE<TFHEpp::lvl1param> ca = TFHEpp::tlweSymEncrypt<TFHEpp::lvl1param>(binary(engine),TFHEpp::lvl1param::alpha,sk->key.lvl1);
    TFHEpp::TLWE<TFHEpp::lvl0param> res;
...
void BM_CMUX(benchmark::State& state){
    ...
    TFHEpp::TRLWE<TFHEpp::lvl1param> c0 = TFHEpp::trlweSymEncrypt<TFHEpp::lvl1param>(pmu0,TFHEpp::lvl1param::alpha,sk->key.lvl1);
    TFHEpp::TRLWE<TFHEpp::lvl1param> c1 = TFHEpp::trlweSymEncrypt<TFHEpp::lvl1param>(pmu1,TFHEpp::lvl1param::alpha,sk->key.lvl1);
