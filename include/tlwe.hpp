...
public:
    ...
    double half;
    double half_d;
    int bp;  // bit precision including noise bit (lvl0param::T - bp is padding
             // bit)
    ...
    {
        // return static_cast<lvl0param::T>(int64_t((d - int64_t(d)) * (1LL <<
        // this->bp)));
        double tmp = d - floor(d);
    ...
    {
        double tmp_0_1 = static_cast<double>(x) /
                         pow(2, std::numeric_limits<lvl0param::T>::digits);
        return tmp_0_1;
    }
